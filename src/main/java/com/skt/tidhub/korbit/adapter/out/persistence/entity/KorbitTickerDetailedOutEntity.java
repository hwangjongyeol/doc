...
@ApiModel(description = "시장 현황 상세정보 결과 Entity", value = "KorbitTickerDetailedOutEntity")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class KorbitTickerDetailedOutEntity implements Serializable {
	
	private static final long serialVersionUID = 798518298917233561L;
